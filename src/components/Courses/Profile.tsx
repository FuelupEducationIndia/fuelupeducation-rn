    ...
    {/* For Menu */}
      ...
      > 
        ...
        <Text
           ...
           <TextInput
  style={{  height:40,
   width:300,backgroundColor:'#E5E5E5',borderRadius:10,marginHorizontal:20,top:3}}
 placeholder=""  
  />    
        </View>
        <View style={{top:50}}>
        <Text       
             ...
             <Text   
               style={[
                 theme.textVariants.body,
                 { color: theme.colors.Orange, fontSize:18,top:3,marginHorizontal:140},
               ]}>
             *
           </Text>
           </Text>
           ...
           <TextInput
  style={{  height:40,
   width:300,backgroundColor:'#E5E5E5',borderRadius:10,top:3,marginHorizontal:20}}
 placeholder=""  
  />    
        </View>
...
<Dropdown/>
    ...
    <Text
     ...
     <Text
           ...
           <TextInput
  style={{  height:40,
   width:300,backgroundColor:'#E5E5E5',borderRadius:10,top:15,marginHorizontal:20}}
 placeholder=""  
  />    
  ...
  />    
    ...
    <Text
     ...
     <Text
           ...
           <TextInput
  style={{  height:40,
   width:300,backgroundColor:'#E5E5E5',borderRadius:10,marginHorizontal:20,top:5}}
 placeholder=""  
  />    
  </View>
       <View style={{top:130}}>
...
/>    
  ...
  <Text
        ...
        <TextInput
style={{  height:40,
width:300,backgroundColor:'#E5E5E5',borderRadius:10,top:5,marginHorizontal:20}}
placeholder=""  
/>    
...
/>    
    ...
    <View style={{paddingVertical:130, borderBottomRightRadius:20,top:30}}>
    <Text
    ...
    <View style={styles.container}>
      ...
      onRequestClose={()=>changeModalVisible2(false)}>
       ...
       <QRcode onPress={()=>changeModalVisible2(false)}/>
        ...
        <View style={{top:40}}>
          <TouchableOpacity onPress={props.onPress} style={{height:35,width:140,backgroundColor:'#F16600',borderRadius:10,marginHorizontal:170}}>
          <Text
