...
<TouchableOpacity onPress={() => onSelect9(index)} style={{height:20,width:20,justifyContent:'center',marginHorizontal:2,top:5}}>
      <Minus/>
</TouchableOpacity>
  ...
  <Text style={{color:theme.colors.darkSilver,marginVertical:10,marginHorizontal:20}}>
  Lorem ipsum dolor sit amet, tempor incididunt ut labore  
  <Text style={{color:theme.colors.darkSilver,marginVertical:10,fontWeight:'bold'}}>
… See more
</Text>
  </Text>
  </View>
  ...
  return(
    <View style={{flexDirection:'row',height:100,borderTopWidth:1,borderBottomWidth:1}}>
      <TouchableOpacity onPress={() => onSelect8(index)}
       style={{height:20,width:20,justifyContent:'center',top:15,marginHorizontal:3,}}>
        <Add/>
         </TouchableOpacity>
...
The Solar System
   ...
   <Text
       ...
       style={[
         theme.textVariants.body,
         { color: theme.colors.text, fontSize:15,top:8,marginHorizontal:5},
       ]}>
    The Moon
   </Text>
   <View style={{width:140}}>
   <Text
    ...
    <Text
       ...
       style={[
         theme.textVariants.body,
         { color: theme.colors.text, fontSize:15,top:8,marginHorizontal:10,fontWeight:'bold'},
       ]}>
… See more
</Text>
   </Text>
...
<View
  style={{
   ...
   <Text
       ...
       style={[
         theme.textVariants.body,
         { color: theme.colors.text, fontSize:18,top:10,marginHorizontal:5},
       ]}>
     Discription
   </Text>
