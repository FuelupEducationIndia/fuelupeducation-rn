...
<TouchableOpacity style={{backgroundColor:theme.colors.primary,paddingHorizontal:20,marginVertical:15,paddingVertical:5,borderRadius:15,marginHorizontal:10}}>
